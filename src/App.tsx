    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-cyan-500/30">
      ...
      <header className="sticky top-0 z-40 bg-slate-900/80 backdrop-blur-xl border-b border-slate-800 px-4 py-3">
        <div className="max-w-md mx-auto flex items-center justify-between">
          ...
          <button
            onClick={() => setPage(user.vip ? 'profile' : 'vip')}
      ...
      <main className="max-w-md mx-auto p-4 pb-24">
        {adminPanel ? (
          ...
          <AnimatePresence mode="wait">
                ...
                <div className="bg-slate-900 rounded-2xl border border-slate-800 p-6 space-y-6">
                  <div className="flex items-center justify-between">
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      ...
                      <div className="w-11 h-6 bg-slate-800 rounded-full peer peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-cyan-500" />
                    </label>
                  </div>
            ...
            {/* VIP */}
            {page === 'vip' && (
              <motion.div key="vip" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="space-y-6">
        ...
        {tradeModal && (
          <div className="fixed inset-0 z-[60] flex items-end justify-center p-4">
            ...
            >
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    />
                    <button onClick={() => setAmount(user.balance)}
              ...
              <button onClick={handleTrade} disabled={amount > user.balance}
                className="w-full bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-400 hover:to-purple-500 disabled:from-slate-800 disabled:to-slate-800 disabled:text-slate-600 text-slate-900 font-black py-4 rounded-2xl shadow-xl shadow-cyan-500/20 transition-all active:scale-[0.98]"
              >
